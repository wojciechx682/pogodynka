...
class WeatherCityNameCommand extends Command
{
    ...
    {
        $this
            ->addArgument('cityName', InputArgument::REQUIRED, 'cityName')
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $result = $this->weatherUtil->getWeatherForLocationByName($cityName);
